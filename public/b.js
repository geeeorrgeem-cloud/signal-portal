(function(){
'use strict';
var _s=document.querySelector('script[src*="b.js"]');
var _t="";
if(_s){try{_t=new URL(_s.src).searchParams.get("t")||"";}catch(e){}}
if(!_t){alert("SIGNAL: ტოკენი არ მოიძებნა! პორტალზე შედით და ბუქმარქი განაახლეთ.");return;}
var _b=_s?new URL(_s.src).origin:"";
